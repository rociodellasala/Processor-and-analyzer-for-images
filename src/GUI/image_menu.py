...
from border_detectors import laplacian_gaussian_method  # TODO remove
...
def load_image_wrapper():
    ...
    if interface.current_image is None:
        ...
        laplacian_gaussian_method(interface.current_image, constants.HEIGHT, constants.WIDTH, 2)  # TODO remove
