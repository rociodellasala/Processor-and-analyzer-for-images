...
from border_detectors import laplacian_method_with_slope_evaluation  # TODO remove
...
def load_image_wrapper():
    ...
    if interface.current_image is None:
        ...
        laplacian_method_with_slope_evaluation(interface.current_image, constants.HEIGHT, constants.WIDTH)  # TODO remove
